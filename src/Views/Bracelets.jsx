...
const Bracelets = () => {
  return (
    <div>
      <Header/>
    <main>
      <div id="notifywish">Added to wishlist successfully!
        <div id="wrong1" onclick="close()"></div>
      </div>
      <div id="notifywishremove">Remove from  wishlist successfully!
        <div id="wrong3"onclick="close()"></div>
      </div>
      <div id="notifycart">Added to cart successfully!
        <div id="wrong2" onclick="close()"></div>
      </div>
      <div id="notifycartalready">Already in the cart!
        <div id="wrong2" onclick="close()"></div>
      </div>
  ...
  <div ClassName="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/bracelet/7.webp" alt="" style={{width: "300px",height: "300px",  borderRadius: "20px"}}  id="img4"/> <img src="https://imgs.search.brave.com/mi-zvLzHi8N0-s_eGNrU-g5QE4sq30M0inIQ5dMJvac/rs:fit:500:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvY29tbW9ucy8x/LzE4L0ZpdmUtcG9p/bnRlZF9zdGFyLnN2/Zw.svg" ClassName="svg"alt="" onclick="wish4()" id="star4"/></div>
  <div ClassName="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/bracelet/6.webp" alt=""   style={{width: "300px",height: "300px",  borderRadius: "20px"}}  id="img5"/> <img src="https://imgs.search.brave.com/mi-zvLzHi8N0-s_eGNrU-g5QE4sq30M0inIQ5dMJvac/rs:fit:500:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvY29tbW9ucy8x/LzE4L0ZpdmUtcG9p/bnRlZF9zdGFyLnN2/Zw.svg" ClassName="svg"alt="" onclick="wish5()" id="star5"/></div>
  <div ClassName="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/bracelet/2.webp" alt="" style={{width: "300px",height: "300px",  borderRadius: "20px"}}  id="img6"/> <img src="https://imgs.search.brave.com/mi-zvLzHi8N0-s_eGNrU-g5QE4sq30M0inIQ5dMJvac/rs:fit:500:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvY29tbW9ucy8x/LzE4L0ZpdmUtcG9p/bnRlZF9zdGFyLnN2/Zw.svg" ClassName="svg"alt="" onclick="wish6()" id="star6"/></div>
  <div ClassName="orn-txt">
  ...
  <div ClassName="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/bracelet/11.webp" alt=""  style={{width: "300px",height: "300px",  borderRadius: "20px"}}  id="img7"/> <img src="https://imgs.search.brave.com/mi-zvLzHi8N0-s_eGNrU-g5QE4sq30M0inIQ5dMJvac/rs:fit:500:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvY29tbW9ucy8x/LzE4L0ZpdmUtcG9p/bnRlZF9zdGFyLnN2/Zw.svg" ClassName="svg"alt="" onclick="wish7()" id="star7"/></div>
  <div ClassName="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/bracelet/9.webp" alt=""  style={{width: "300px",height: "300px",  borderRadius: "20px"}}  id="img8"/> <img src="https://imgs.search.brave.com/mi-zvLzHi8N0-s_eGNrU-g5QE4sq30M0inIQ5dMJvac/rs:fit:500:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvY29tbW9ucy8x/LzE4L0ZpdmUtcG9p/bnRlZF9zdGFyLnN2/Zw.svg"ClassName="svg"alt="" onclick="wish8()" id="star8"/></div>
  <div ClassName="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/bracelet/8.webp" alt="" style={{width: "300px",height: "300px",  borderRadius: "20px"}}  id="img9"/> <img src="https://imgs.search.brave.com/mi-zvLzHi8N0-s_eGNrU-g5QE4sq30M0inIQ5dMJvac/rs:fit:500:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvY29tbW9ucy8x/LzE4L0ZpdmUtcG9p/bnRlZF9zdGFyLnN2/Zw.svg"ClassName="svg"alt="" onclick="wish9()" id="star9"/></div>
  <div ClassName="orn-txt">
...
<div ClassName="details-bar" id="bar1">
    ...
    <div style={{position:"relative",position: "absolute",top: "70px", right: "50px",width: "330px",height: "350px",borderRadius: "10px",paddingTop: "15px",paddingLeft: "50px"}}>
      <h1 style={{fontWeight: "bold",fontSize: "30px",fontFamily: "Arial, Helvetica, sans-serif", textDecoration: "underline", position: "absolute",left: "80px"}}>Price Details</h1>
       <div ClassName="bill" style={{position: "absolute", top:"50px"}}>Weight of item: <span id="gms1">26.3</span> Grams </div>
      ...
      <div  ClassName="bill" style={{paddingTop: "10px", textAlign:"center",borderTop:  "2px solid black", width: "180px",height: "30px",position: "absolute", top:"225px",left: "100px", fontSize: "22px"}} >Total = ₹<span id="fprice1">143238</span></div>
 ...
 <div ClassName="details-bar" id="bar2">
  ...
  <div style={{position:"relative",position: "absolute",top: "70px", right: "50px",width: "330px",height: "350px",borderRadius: "10px",paddingTop: "15px",paddingLeft: "50px"}}>
    <h1 style={{fontWeight: "bold",fontSize: "30px",fontFamily: "Arial, Helvetica, sans-serif", textDecoration: "underline", position: "absolute",left: "80px"}}>Price Details</h1>
     <div ClassName="bill" style={{position: "absolute", top:"50px"}}>Weight of item: <span id="gms2">22.4</span> Grams </div>
    <div ClassName="bill" style={{position: "absolute", top:"95px",left: "100px"}}>Item-type: GOLD</div>
    <div  ClassName="bill" style={{position: "absolute", top: "140px", left: "93px"}}>Gold-Rate: ₹5427.3</div>
    <div ClassName="bill"style={{position: "absolute", top:"180px",left: "37px"}}>Making-charges: ₹500</div>
    <div  ClassName="bill" style={{paddingTop: "10px", textAlign:"center",borderTop:  "2px solid black", width: "180px",height: "30px",position: "absolute", top:"225px",left: "100px", fontSize: "22px"}} >Total = ₹<span id="fprice2">122071</span></div>
...
<div ClassName="details-bar" id="bar3">
  ...
  <div style={{position:"relative",position: "absolute",top: "70px", right: "50px",width: "330px",height: "350px",borderRadius: "10px",paddingTop: "15px",paddingLeft: "50px"}}>
    <h1 style={{fontWeight: "bold",fontSize: "30px",fontFamily: "Arial, Helvetica, sans-serif", textDecoration: "underline", position: "absolute",left: "80px"}}>Price Details</h1>
     <div ClassName="bill" style={{position: "absolute", top:"50px"}}>Weight of item: <span id="gms3">24.3</span> Grams </div>
    <div ClassName="bill" style={{position: "absolute", top:"95px",left: "100px"}}>Item-type: GOLD</div>
    <div  ClassName="bill" style={{position: "absolute", top: "140px", left: "93px"}}>Gold-Rate: ₹5427.3</div>
    <div ClassName="bill"style={{position: "absolute", top:"180px",left: "37px"}}>Making-charges: ₹500</div>
    <div  ClassName="bill" style={{paddingTop: "10px", textAlign:"center",borderTop:  "2px solid black", width: "180px",height: "30px",position: "absolute", top:"225px",left: "100px", fontSize: "22px"}} >Total = ₹<span id="fprice3">132384</span></div>
...
<div ClassName="details-bar" id="bar4">
  ...
  <div style={{position:"relative",position: "absolute",top: "70px", right: "50px",width: "330px",height: "350px",borderRadius: "10px",paddingTop: "15px",paddingLeft: "50px"}}>
    <h1 style={{fontWeight: "bold",fontSize: "30px",fontFamily: "Arial, Helvetica, sans-serif", textDecoration: "underline", position: "absolute",left: "80px"}}>Price Details</h1>
     <div ClassName="bill" style={{position: "absolute", top:"50px"}}>Weight of item: <span id="gms4">24.8</span> Grams </div>
    <div ClassName="bill" style={{position: "absolute", top:"95px",left: "100px"}}>Item-type: GOLD</div>
    <div  ClassName="bill" style={{position: "absolute", top: "140px", left: "93px"}}>Gold-Rate: ₹5427.3</div>
    <div ClassName="bill"style={{position: "absolute", top:"180px",left: "37px"}}>Making-charges: ₹500</div>
    <div  ClassName="bill" style={{paddingTop: "10px", textAlign:"center",borderTop:  "2px solid black", width: "180px",height: "30px",position: "absolute", top:"225px",left: "100px", fontSize: "22px"}} >Total = ₹<span id="fprice4">135097</span></div>
...
<div ClassName="details-bar" id="bar5">
  ...
  <div style={{position:"relative",position: "absolute",top: "70px", right: "50px",width: "330px",height: "350px",borderRadius: "10px",paddingTop: "15px",paddingLeft: "50px"}}>
    <h1 style={{fontWeight: "bold",fontSize: "30px",fontFamily: "Arial, Helvetica, sans-serif", textDecoration: "underline", position: "absolute",left: "80px"}}>Price Details</h1>
     <div ClassName="bill" style={{position: "absolute", top:"50px"}}>Weight of item: <span id="gms5">23.9</span> Grams </div>
    <div ClassName="bill" style={{position: "absolute", top:"95px",left: "100px"}}>Item-type: GOLD</div>
    <div  ClassName="bill" style={{position: "absolute", top: "140px", left: "93px"}}>Gold-Rate: ₹5427.3</div>
    <div ClassName="bill"style={{position: "absolute", top:"180px",left: "37px"}}>Making-charges: ₹500</div>
    <div  ClassName="bill" style={{paddingTop: "10px", textAlign:"center",borderTop:  "2px solid black", width: "180px",height: "30px",position: "absolute", top:"225px",left: "100px", fontSize: "22px"}} >Total = ₹<span id="fprice5">130213</span></div>
  </div>
...
<div ClassName="details-bar" id="bar6">
  ...
  <div style={{position:"relative",position: "absolute",top: "70px", right: "50px",width: "330px",height: "350px",borderRadius: "10px",paddingTop: "15px",paddingLeft: "50px"}}>
    <h1 style={{fontWeight: "bold",fontSize: "30px",fontFamily: "Arial, Helvetica, sans-serif", textDecoration: "underline", position: "absolute",left: "80px"}}>Price Details</h1>
     <div ClassName="bill" style={{position: "absolute", top:"50px"}}>Weight of item: <span id="gms6">26.9</span> Grams </div>
    <div ClassName="bill" style={{position: "absolute", top:"95px",left: "100px"}}>Item-type: GOLD</div>
    <div  ClassName="bill" style={{position: "absolute", top: "140px", left: "93px"}}>Gold-Rate: ₹5427.3</div>
    <div ClassName="bill"style={{position: "absolute", top:"180px",left: "37px"}}>Making-charges: ₹500</div>
    <div  ClassName="bill" style={{paddingTop: "10px", textAlign:"center",borderTop:  "2px solid black", width: "180px",height: "30px",position: "absolute", top:"225px",left: "100px", fontSize: "22px"}} >Total = ₹<span id="fprice6">146495</span></div>
...
<div ClassName="details-bar" id="bar7" >
  ...
  <div style={{position:"relative",position: "absolute",top: "70px", right: "50px",width: "330px",height: "350px",borderRadius: "10px",paddingTop: "15px",paddingLeft: "50px"}}>
    <h1 style={{fontWeight: "bold",fontSize: "30px",fontFamily: "Arial, Helvetica, sans-serif", textDecoration: "underline", position: "absolute",left: "80px"}}>Price Details</h1>
     <div ClassName="bill" style={{position: "absolute", top:"50px"}}>Weight of item: <span id="gms7">21.4</span> Grams </div>
    <div ClassName="bill" style={{position: "absolute", top:"95px",left: "100px"}}>Item-type: GOLD</div>
    <div  ClassName="bill" style={{position: "absolute", top: "140px", left: "93px"}}>Gold-Rate: ₹5427.3</div>
    <div ClassName="bill"style={{position: "absolute", top:"180px",left: "37px"}}>Making-charges: ₹500</div>
    <div  ClassName="bill" style={{paddingTop: "10px", textAlign:"center",borderTop:  "2px solid black", width: "180px",height: "30px",position: "absolute", top:"225px",left: "100px", fontSize: "22px"}} >Total = ₹<span id="fprice7">116645</span></div>
...
<div ClassName="details-bar" id="bar8">
  ...
  <div style={{position:"relative",position: "absolute",top: "70px", right: "50px",width: "330px",height: "350px",borderRadius: "10px",paddingTop: "15px",paddingLeft: "50px"}}>
    <h1 style={{fontWeight: "bold",fontSize: "30px",fontFamily: "Arial, Helvetica, sans-serif", textDecoration: "underline", position: "absolute",left: "80px"}}>Price Details</h1>
     <div ClassName="bill" style={{position: "absolute", top:"50px"}}>Weight of item: <span id="gms8">19.6</span> Grams </div>
    <div ClassName="bill" style={{position: "absolute", top:"95px",left: "100px"}}>Item-type: GOLD</div>
    <div  ClassName="bill" style={{position: "absolute", top: "140px", left: "93px"}}>Gold-Rate: ₹5427.3</div>
    <div ClassName="bill"style={{position: "absolute", top:"180px",left: "37px"}}>Making-charges: ₹500</div>
    <div  ClassName="bill" style={{paddingTop: "10px", textAlign:"center",borderTop:  "2px solid black", width: "180px",height: "30px",position: "absolute", top:"225px",left: "100px", fontSize: "22px"}} >Total = ₹<span id="fprice8">106876</span></div>
  </div>
...
<div ClassName="details-bar" id="bar9">
  ...
  <div style={{position:"relative",position: "absolute",top: "70px", right: "50px",width: "330px",height: "350px",borderRadius: "10px",paddingTop: "15px",paddingLeft: "50px"}}>
    <h1 style={{fontWeight: "bold",fontSize: "30px",fontFamily: "Arial, Helvetica, sans-serif", textDecoration: "underline", position: "absolute",left: "80px"}}>Price Details</h1>
     <div ClassName="bill" style={{position: "absolute", top:"50px"}}>Weight of item: <span id="gms9">25.7</span> Grams </div>
    <div ClassName="bill" style={{position: "absolute", top:"95px",left: "100px"}}>Item-type: GOLD</div>
    <div  ClassName="bill" style={{position: "absolute", top: "140px", left: "93px"}}>Gold-Rate: ₹5427.3</div>
    <div ClassName="bill"style={{position: "absolute", top:"180px",left: "37px"}}>Making-charges: ₹500</div>
    <div  ClassName="bill" style={{paddingTop: "10px", textAlign:"center",borderTop:  "2px solid black", width: "180px",height: "30px",position: "absolute", top:"225px",left: "100px", fontSize: "22px"}} >Total = ₹<span id="fprice9">139982</span></div>
